...
export default function CreatePost() {
  return (
    <form className="w-full bg-xs-blue h-24 z-50 rounded-md flex flex-col justify-between">
      <ModalInput
        placeHolder="create your post"
        className="h-12 shadow-lg max-w-2xl"
      >
        <div className="w-full flex flex-col px-2 py-2 m-2">
          <textarea
