...
export default function ChatPreview({
  ...
  return (
    <article
      ...
      className="bg-xs-blue dark:bg-d-xs-blue h-14 flex flex-row justify-start rounded-md cursor-pointer hover:opacity-50 border border-xl-blue dark:border-x-d-xl-blue"
    >
